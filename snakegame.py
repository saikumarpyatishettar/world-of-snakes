...
bgimg=pygame.image.load("backgroundimg.png")
...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("welcome to world of snakes",black,260,250)
        text_screen("press the space bar to enter the w orld  ",black,232,290)
...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("Welcome to snake world",black,260,250)
        text_screen("Press space bar to enter the world",black,232,290)
